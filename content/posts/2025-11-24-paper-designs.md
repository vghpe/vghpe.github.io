...
description:
---
When I started designing games professionally, I didn't have the technical skills to   program my own prototypes so with Pen & Paper I designed my games.  

Last week I needed to come up with a lot a lot of ideas so back to the notebook i go.
...
If you draw, your know that the first few sketches are usually trash, so get the first few drawings out fast. Then, once warmed up it gets a lot better. 
...
![Some pages just doesn't give much but that's ok](/images/pen_paper_c.jpg)
...
Coming in to this week I had finished the playable [prototype v1](/posts/nipps-proto) & I come up with a proper fantasy to wrap around the gameplay. 

Fifteen pages of scribbling later I have early designs for:
- 3 new games states (with new mechanics)
- Iterations on the mechanics explored in v1. 
- A full gameplay loop 

The next step is is some code architecture design and then programming. 